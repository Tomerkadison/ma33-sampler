...
public class CrossDataStructure extends Transformer {
    private String[] parameters;
    private DataManager otherData;
    private String primaryKey;
    public CrossDataStructure(DataManager otherData,String primaryKey ,String[] parameters) {
    ...
    public void Transform() {
        ...
        for(HashMap<String,String> record:this.dataManager.getData()){
            for(HashMap<String,String> otherRecord : this.otherData.getData()){
                if(record.get(this.primaryKey) == otherRecord.get(this.primaryKey)){
